...
public class NoteController {
    ...
    public ResponseEntity<?> deleteNote(@PathVariable Integer id) throws NoteIdNotFoundException{
        NotesDto notesDto = noteService.deleteNote(id);
        return new ResponseEntity<>(notesDto,HttpStatus.ACCEPTED);
    }

    @GetMapping("/get/{id}")
    public ResponseEntity<?> getNote(@PathVariable Integer id) throws NoteIdNotFoundException{
